 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Create Course  </h1>
                    </div>
                </div>
                <div class="row" >
...
<div class="form-group">
    <label for="seatlimit">Registerd Student  </label>
...
{
    $courseid = $row['id'];
    $updateQuery = "UPDATE course SET courseUnit = (SELECT COUNT(*) FROM courseenrolls WHERE courseenrolls.course = $courseid) WHERE id = $courseid";
    mysqli_query($bd, $updateQuery);
?>
